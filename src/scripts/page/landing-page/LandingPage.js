  ...
  render(services) {
    this.container.innerHTML = `
      <header class="hero-section">
        <nav class="navbar">
          <img src="../src/public/logo/Main-Logo-White.png" alt="agriedu" class="logo" />
          <div class="nav-right">
            <ul class="nav-links">
      ...
      <section id="aboutUs" class="about">
        <div class="about-images">
          <img src="../src/public/images/About-LandingPage.jpg" />
          <img src="../src/public/images/About-LandingPage2.jpg" />
          <img src="../src/public/images/About-LandingPage3.jpg" />
        </div>
